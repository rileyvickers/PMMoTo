...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "PMMoTo.domainGeneration",
        "sources": [
            "PMMoTo/domainGeneration.pyx"
        ]
    },
    "module_name": "PMMoTo.domainGeneration"
}
END: Cython Metadata */
...
#define __PYX_HAVE__PMMoTo__domainGeneration
#define __PYX_HAVE_API__PMMoTo__domainGeneration
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'PMMoTo.domainGeneration' */
...
static int __pyx_f_6PMMoTo_16domainGeneration_inAtom(double, double, double, double, double, double, double); /*proto*/
...
#define __Pyx_MODULE_NAME "PMMoTo.domainGeneration"
extern int __pyx_module_is_main_PMMoTo__domainGeneration;
int __pyx_module_is_main_PMMoTo__domainGeneration = 0;

/* Implementation of 'PMMoTo.domainGeneration' */
...
static const char __pyx_k_PMMoTo_domainGeneration[] = "PMMoTo.domainGeneration";
static const char __pyx_k_contiguous_and_indirect[] = "<contiguous and indirect>";
static const char __pyx_k_Cannot_index_with_type_s[] = "Cannot index with type '%s'";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_PMMoTo_domainGeneration_pyx[] = "PMMoTo/domainGeneration.pyx";
...
static PyObject *__pyx_n_s_PMMoTo_domainGeneration;
static PyObject *__pyx_kp_s_PMMoTo_domainGeneration_pyx;
...
static PyObject *__pyx_pf_6PMMoTo_16domainGeneration_domainGen(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z, __Pyx_memviewslice __pyx_v_atom); /* proto */
static PyObject *__pyx_pf_6PMMoTo_16domainGeneration_2domainGenINK(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z); /* proto */
...
/* "PMMoTo/domainGeneration.pyx":13
 * 
 * 
...
static int __pyx_f_6PMMoTo_16domainGeneration_inAtom(double __pyx_v_cx, double __pyx_v_cy, double __pyx_v_cz, double __pyx_v_x, double __pyx_v_y, double __pyx_v_z, double __pyx_v_r) {
  double __pyx_v_re;
  int __pyx_r;
  ...
  /* "PMMoTo/domainGeneration.pyx":15
 * cdef int inAtom(double cx,double cy,double cz,double x,double y,double z,double r):
 *     cdef double re
 *     re = (cx - x)*(cx - x) + (cy - y)*(cy - y) + (cz - z)*(cz - z)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":16
 *     cdef double re
 *     re = (cx - x)*(cx - x) + (cy - y)*(cy - y) + (cz - z)*(cz - z)
 *     if (re <= r): # already calculated 0.25*r*r             # <<<<<<<<<<<<<<
 *         return 0
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "PMMoTo/domainGeneration.pyx":17
 *     re = (cx - x)*(cx - x) + (cy - y)*(cy - y) + (cz - z)*(cz - z)
 *     if (re <= r): # already calculated 0.25*r*r
 *         return 0             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":19
 *         return 0
 *     else:
 *         return 1             # <<<<<<<<<<<<<<
 * 
...
/* "PMMoTo/domainGeneration.pyx":22
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_6PMMoTo_16domainGeneration_1domainGen(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6PMMoTo_16domainGeneration_1domainGen = {"domainGen", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6PMMoTo_16domainGeneration_1domainGen, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6PMMoTo_16domainGeneration_1domainGen(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("PMMoTo.domainGeneration.domainGen", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6PMMoTo_16domainGeneration_domainGen(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_z, __pyx_v_atom);
...
static PyObject *__pyx_pf_6PMMoTo_16domainGeneration_domainGen(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z, __Pyx_memviewslice __pyx_v_atom) {
  int __pyx_v_NX;
  int __pyx_v_NY;
  int __pyx_v_NZ;
  ...
  /* "PMMoTo/domainGeneration.pyx":24
 * def domainGen( double[:] x, double[:] y, double[:] z, double[:,:] atom):
 * 
 *     cdef int NX = x.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":25
 * 
 *     cdef int NX = x.shape[0]
 *     cdef int NY = y.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int NZ = z.shape[0]
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":26
 *     cdef int NX = x.shape[0]
 *     cdef int NY = y.shape[0]
 *     cdef int NZ = z.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int numObjects = atom.shape[1]
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":27
 *     cdef int NY = y.shape[0]
 *     cdef int NZ = z.shape[0]
 *     cdef int numObjects = atom.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":32
 * 
 * 
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":35
 *     cdef cnp.uint8_t [:,:,:] grid
 * 
 *     grid = _grid             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":37
 *     grid = _grid
 * 
 *     for i in range(0,NX):             # <<<<<<<<<<<<<<
 *       for j in range(0,NY):
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "PMMoTo/domainGeneration.pyx":38
 * 
 *     for i in range(0,NX):
 *       for j in range(0,NY):             # <<<<<<<<<<<<<<
 *         for k in range(0,NZ):
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "PMMoTo/domainGeneration.pyx":39
 *     for i in range(0,NX):
 *       for j in range(0,NY):
 *         for k in range(0,NZ):             # <<<<<<<<<<<<<<
 *           c = 0
 ...
 */
      ...
      for (__pyx_t_15 = 0; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
        ...
        /* "PMMoTo/domainGeneration.pyx":40
 *       for j in range(0,NY):
 *         for k in range(0,NZ):
 *           c = 0             # <<<<<<<<<<<<<<
 *           while (grid[i,j,k] == 1 and c < numObjects):
 ...
 */
        ...
        /* "PMMoTo/domainGeneration.pyx":41
 *         for k in range(0,NZ):
 *           c = 0
 *           while (grid[i,j,k] == 1 and c < numObjects):             # <<<<<<<<<<<<<<
 *               grid[i,j,k] = inAtom(atom[0,c],atom[1,c],atom[2,c],x[i],y[j],z[k],atom[3,c])
 ...
 */
        while (1) {
          ...
          /* "PMMoTo/domainGeneration.pyx":42
 *           c = 0
 *           while (grid[i,j,k] == 1 and c < numObjects):
 *               grid[i,j,k] = inAtom(atom[0,c],atom[1,c],atom[2,c],x[i],y[j],z[k],atom[3,c])             # <<<<<<<<<<<<<<
 *               c = c + 1
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":45
 *               c = c + 1
 * 
 *     return _grid             # <<<<<<<<<<<<<<
 * 
...
/* "PMMoTo/domainGeneration.pyx":48
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_6PMMoTo_16domainGeneration_3domainGenINK(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6PMMoTo_16domainGeneration_3domainGenINK = {"domainGenINK", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6PMMoTo_16domainGeneration_3domainGenINK, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6PMMoTo_16domainGeneration_3domainGenINK(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_y = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_z = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("PMMoTo.domainGeneration.domainGenINK", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6PMMoTo_16domainGeneration_2domainGenINK(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_z);
...
static PyObject *__pyx_pf_6PMMoTo_16domainGeneration_2domainGenINK(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z) {
  int __pyx_v_NX;
  int __pyx_v_NY;
  int __pyx_v_NZ;
  int __pyx_v_i;
  ...
  /* "PMMoTo/domainGeneration.pyx":50
 * def domainGenINK(double[:] x, double[:] y, double[:] z):
 * 
 *     cdef int NX = x.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int NY = y.shape[0]
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":51
 * 
 *     cdef int NX = x.shape[0]
 *     cdef int NY = y.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int NZ = z.shape[0]
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":52
 *     cdef int NX = x.shape[0]
 *     cdef int NY = y.shape[0]
 *     cdef int NZ = z.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int i, j, k
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":56
 *     cdef double r
 * 
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":59
 *     cdef cnp.uint8_t [:,:,:] grid
 * 
 *     grid = _grid             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":61
 *     grid = _grid
 * 
 *     for i in range(0,NX):             # <<<<<<<<<<<<<<
 *       for j in range(0,NY):
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "PMMoTo/domainGeneration.pyx":62
 * 
 *     for i in range(0,NX):
 *       for j in range(0,NY):             # <<<<<<<<<<<<<<
 *         for k in range(0,NZ):
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "PMMoTo/domainGeneration.pyx":63
 *     for i in range(0,NX):
 *       for j in range(0,NY):
 *         for k in range(0,NZ):             # <<<<<<<<<<<<<<
 *           r = (0.01*math.cos(0.01*x[i]) + 0.5*math.sin(x[i]) + 0.75)
 ...
 */
      ...
      for (__pyx_t_15 = 0; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
        ...
        /* "PMMoTo/domainGeneration.pyx":64
 *       for j in range(0,NY):
 *         for k in range(0,NZ):
 *           r = (0.01*math.cos(0.01*x[i]) + 0.5*math.sin(x[i]) + 0.75)             # <<<<<<<<<<<<<<
 *           if y[j]*y[j] + z[k]*z[k] <= r*r:
 ...
 */
        ...
        /* "PMMoTo/domainGeneration.pyx":65
 *         for k in range(0,NZ):
 *           r = (0.01*math.cos(0.01*x[i]) + 0.5*math.sin(x[i]) + 0.75)
 *           if y[j]*y[j] + z[k]*z[k] <= r*r:             # <<<<<<<<<<<<<<
 *             grid[i,j,k] = 1
 ...
 */
        ...
        if (__pyx_t_21) {
          ...
          /* "PMMoTo/domainGeneration.pyx":66
 *           r = (0.01*math.cos(0.01*x[i]) + 0.5*math.sin(x[i]) + 0.75)
 *           if y[j]*y[j] + z[k]*z[k] <= r*r:
 *             grid[i,j,k] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":68
 *             grid[i,j,k] = 1
 * 
 *     return _grid             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "PMMoTo.domainGeneration.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "PMMoTo.domainGeneration.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "PMMoTo.domainGeneration.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "PMMoTo.domainGeneration._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_domainGeneration(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_domainGeneration},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_PMMoTo_domainGeneration, __pyx_k_PMMoTo_domainGeneration, sizeof(__pyx_k_PMMoTo_domainGeneration), 0, 0, 1, 1},
  {&__pyx_kp_s_PMMoTo_domainGeneration_pyx, __pyx_k_PMMoTo_domainGeneration_pyx, sizeof(__pyx_k_PMMoTo_domainGeneration_pyx), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(4, 0, 14, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_PMMoTo_domainGeneration_pyx, __pyx_n_s_domainGen, 22, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 22, __pyx_L1_error)
 ...
 */
  ...
  __pyx_codeobj__24 = (PyObject*)__Pyx_PyCode_New(3, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__23, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_PMMoTo_domainGeneration_pyx, __pyx_n_s_domainGenINK, 48, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__24)) __PYX_ERR(0, 48, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initdomainGeneration(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initdomainGeneration(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_domainGeneration(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_domainGeneration(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_domainGeneration(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'domainGeneration' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_domainGeneration(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("domainGeneration", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_PMMoTo__domainGeneration) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "PMMoTo.domainGeneration")) {
      if (unlikely(PyDict_SetItemString(modules, "PMMoTo.domainGeneration", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  /* "PMMoTo/domainGeneration.pyx":10
 * cimport numpy as cnp
 * from libc.stdio cimport printf
 * cnp.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 *     cdef int NX = x.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6PMMoTo_16domainGeneration_1domainGen, NULL, __pyx_n_s_PMMoTo_domainGeneration); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     cdef int NX = x.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6PMMoTo_16domainGeneration_3domainGenINK, NULL, __pyx_n_s_PMMoTo_domainGeneration); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_domainGenINK, __pyx_t_1) < 0) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "PMMoTo/domainGeneration.pyx":1
 * #cython: cdivision=True             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init PMMoTo.domainGeneration", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init PMMoTo.domainGeneration");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
